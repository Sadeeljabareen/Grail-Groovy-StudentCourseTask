...
<div id="content" role="main">
    <div class="container">
        <section class="row">
            <a href="#list-enrollment" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <g:textField name="studentName" value="${params.studentName}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <g:textField name="courseTitle" value="${params.courseTitle}"
                                                     class="form-control" placeholder="Search by course title"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <g:textField name="grade" value="${params.grade}" class="form-control"
            ...
            <div id="list-enrollment" class="col-12 content scaffold-list" role="main">
                ...
                <g:if test="${enrollmentCount > params.int('max')}">
                    <div class="pagination">
                        <g:paginate total="${enrollmentCount ?: 0}" params="${params}" action="index"
